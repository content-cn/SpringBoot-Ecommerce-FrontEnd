...
import { FaTruck, FaLaravel, FaHeadset } from "react-icons/fa";
...
function NavbarFinal() {
  ...
  let { isAuth, userData } = useSelector((store) => store.AuthManager);
    ...
    return (
      <Box>
        <Navbar bg="dark" variant="dark">
          <Container>
            <Navbar.Brand href="#home">CN Shoping</Navbar.Brand>
            <Nav className="justify-content-end" >
              ...
              <Nav.Link href="#quality">
                {/* <FaLaravel /> */}
                Quality ensurity
              </Nav.Link>
              <Nav.Link href="#findStore">
                {/* <ImLocation2 /> */}
                Find Store
              </Nav.Link>
        ...
        >
          <Link to="/">
            <Box>
              <Image src="mainlogo1.jpg" alt="logo" w="190px" h="70px" />
            </Box>
          </Link>
          <Flex
            bg="white"
          ...
          >
            ...
            />
            <FcSearch fontSize={"42px"} onClick={handleSearch}/>
          </Flex>
          <Link to="/cart">
            <Flex cursor={"pointer"}>
          ...
          {!isAuth ? (
            ...
            <Menu>
              ...
              <MenuList>
                ...
                <MenuItem onClick={handleOrders}>My Order</MenuItem>
                <MenuItem onClick={handleAddress}>My Address</MenuItem>
              ...
              <Link to="computers">
                ...
                >
                  ...
                  <Box>
                    ...
                    >
                      Upto 72% Off, Only on cnshopping
                    </Text>
                    <Text
                      _hover={{
                        textDecoration: "underline",
